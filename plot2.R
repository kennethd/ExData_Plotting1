...
d <- read.csv(LOCAL_TXT_FILE_NAME, sep = ";", stringsAsFactors = FALSE,
...
# create line plot of Global Active Power for our 2 days' data
png(filename = "plot2.png", height = 480, width = 480)
plot(x = d$Time, y = d$Global_active_power, type = "l",
